    ...
    return (
        <div className='pt-[48px]'>
            {loading ? ( // Show loading animation if loading is true
                <div className="absolute top-0 left-0 flex items-center justify-center w-screen loader h-[100vh]">
                    <div role="status">
                ...
                certifications.map((cert, index) => (
                    <div className='p-3 mb-2 rounded-lg bg-slate-100 font-ro' key={index}>
...
export default Fullcertification;

...
function ProjectCard(props) {
  ...
  return (
    <div data-aos="fade-top"  data-aos-offset="200" data-aos-easing="ease" data-aos-duration="600" className=' w-4/6   sm:w-5/12 md:w-3/12 border border-[0.1px]  rounded-r-xl rounded-bl-xl  m-3 relative flex flex-col justify-center p-3 border-[#264736]/30 ' >
